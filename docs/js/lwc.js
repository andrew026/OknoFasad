...
(function ($lwc)
{
    ...
    function lightcalc()
    {
        ...
        var wintypes = 
        {
            type_1_1 : 
            {
                width : 100 * 1 + 54 * 2, marginTop : 30, leaf_w : 100, wnd_top : 0, wnd_left : {
                    'глухая' : 'leaf-b-0', 'поворотная' : 'leaf-b-1-r', 'поворотно-откидная' : 'leaf-b-3-r'
                },
                wnd_cntr : 0, wnd_right : 0, byDef : {
                    1 : 'поворотная'
                }
            },
            type_1_2 : 
            {
                width : 100 * 2 + 54 * 2, marginTop : 30, leaf_w : 100, wnd_top : 0, wnd_left : {
                    'глухая' : 'leaf-b-0', 'поворотная' : 'leaf-b-1-l', 'поворотно-откидная' : 'leaf-b-3-l'
                },
                wnd_cntr : {
                    'глухая' : 'leaf-b-0', 'поворотная' : 'leaf-b-1-r', 'поворотно-откидная' : 'leaf-b-3-r'
                },
                wnd_right : 0, byDef : {
                    1 : 'глухая', 2 : 'поворотная'
                }
            },
            type_1_3 : 
            {
                width : 100 * 3 + 54 * 2, marginTop : 30, leaf_w : 100, wnd_top : 0, wnd_left : {
                    'глухая' : 'leaf-b-0', 'поворотная' : 'leaf-b-1-l', 'поворотно-откидная' : 'leaf-b-3-l'
                },
                wnd_cntr : {
                    'глухая' : 'leaf-b-0', 'поворотная' : 'leaf-b-1-r', 'поворотно-откидная' : 'leaf-b-3-r'
                ...
                byDef : {
                    1 : 'глухая', 2 : 'поворотная', 3 : 'глухая'
                }
            },
            type_2_1 : 
            {
                width : 95 * 1 + 54 * 2, marginTop : 5, leaf_w : 95, wnd_top : {
                    'глухая' : 'leaf-f-1-0'
                },
                wnd_left : {
                    'глухая' : 'leaf-m-0', 'поворотная' : 'leaf-m-1-r', 'поворотно-откидная' : 'leaf-m-3-r'
                },
                wnd_cntr : 0, wnd_right : 0, byDef : {
                    0 : 'глухая', 1 : 'поворотная'
                }
            },
            type_2_2 : 
            {
                width : 95 * 2 + 54 * 2, marginTop : 5, leaf_w : 95, wnd_top : {
                    'глухая' : 'leaf-f-2-0'
                },
                wnd_left : {
                    'глухая' : 'leaf-m-0', 'поворотная' : 'leaf-m-1-l', 'поворотно-откидная' : 'leaf-m-3-l'
                },
                wnd_cntr : {
                    'глухая' : 'leaf-m-0', 'поворотная' : 'leaf-m-1-r', 'поворотно-откидная' : 'leaf-m-3-r'
                },
                wnd_right : 0, byDef : {
                    0 : 'глухая', 1 : 'глухая', 2 : 'поворотная'
                }
            },
            type_2_3 : 
            {
                width : 95 * 3 + 54 * 2, marginTop : 5, leaf_w : 95, wnd_top : {
                    'глухая' : 'leaf-f-3-0'
                },
                wnd_left : {
                    'глухая' : 'leaf-m-0', 'поворотная' : 'leaf-m-1-l', 'поворотно-откидная' : 'leaf-m-3-l'
                ...
                byDef : {
                    0 : 'глухая', 1 : 'глухая', 2 : 'поворотная', 3 : 'глухая'
                }
            },
            type_3_1 : 
            {
                width : 95 * 2 + 54 * 2, leaf_w : 95, wnd_top : 0, wnd_left : {
                    'поворотная' : 'leaf-d-1'
                },
                wnd_cntr : {
                    'глухая' : 'leaf-m-0', 'поворотная' : 'leaf-m-1-r', 'поворотно-откидная' : 'leaf-m-3-r'
                ...
                wnd_right : 0, byDef : {
                    1 : 'поворотная', 2 : 'глухая'
                }
            },
            type_3_2 : 
            {
                width : 95 * 3 + 54 * 2, leaf_w : 95, wnd_top : 0, wnd_left : {
                    'поворотная' : 'leaf-d-1'
                },
                wnd_cntr : {
                    'глухая' : 'leaf-m-0'
                ...
                byDef : {
                    1 : 'поворотная', 2 : 'глухая', 3 : 'поворотная'
                }
            }
        };
        ...
        {
            var leaf = $(this).attr('id'), type = $('.lwc-menu-li a.selected').attr('id'), title = $(this).attr('title'), 
            variant = wintypes[type][leaf], variants = null, next = null, nextleaf = null, newvariants = null;
        ...
        $('#lwc-mnt').change(function () {}).change();
        ...
        {
            getMark();
            var m = $lwc.mark, pr = $lwc.price, e = $lwc.e, ext = $lwc.ext, houses = $lwc.houses, celm, 
            total, economy = 0, other = 0, nval, vval, p = m.p, s = m.s, sgl = m.sgl, sf = m.sf, nf = m.nf, 
            w = m.w, h = m.h, prifilename = $lwc.profiles[e.profiles.val()].name, furnprice = pr.furn[prifilename], 
            Production = m.p * (pr.profil[e.profiles.val()] + pr.color[e.colors.val()]);
            ...
            var intv = 25, msecs = 750, steps = msecs / intv, acurprice = $('#lwc-price-sum').text().match(/[0-9]+/), 
            acureconomy = $('#lwc-economy-sum').text().match(/[0-9]+/), curprice = acurprice ? acurprice[0] : 0, 
            newprice = total, cureconomy = acureconomy ? acureconomy[0] : 0, neweconomy = economy, priceplus = (curprice - newprice) / steps, 
            economyplus = (cureconomy - neweconomy) / steps, pp = 0, ee = 0, timer = setInterval(function ()
            {
                if (steps >= 0)
                {
        ...
        function getMark()
        {
            function numVal(sel)
            {
                ...
                if (isNaN(x) || !$x.is(':visible')) {
                    x = 0;
                }
                return x;
            };
            var m = $lwc.mark = {
                p : 0, s : 0, sf : 0, sgl : 0, nf : 0, w : 0, h : 0
            },
            cs, wgl, hgl;
            ...
            if (m.wt.door) {
                m["height_" + m.wt.door] = numVal('#lwc-input-door-height');
            }
            ...
            if (m.width_left) {
                m.furn_left = $('#wnd_left').attr('title');
            }
            else {
                m.furn_left = "";
            }
            if (m.width_cntr) {
                m.furn_cntr = $('#wnd_cntr').attr('title');
            }
            else {
                m.furn_cntr = "";
            }
            if (m.width_right) {
                m.furn_right = $('#wnd_right').attr('title');
            }
            else {
                m.furn_right = "";
            }
            if (m.height_top) {
                m.furn_top = $('#wnd_top').attr('title');
            }
            else {
                m.furn_top = "";
            }
        ...
        function priceFormat(pr)
        {
            ...
            if (!$lwc.price.hasOwnProperty("currency_name")) {
                $lwc.price.currency_name = " руб.";
            }
        ...
        function postPrms(Total)
        {
            ...
            if ($('#lwc-economy').is(':checked')) {
                ...
                orderparams += 'Ориентировочная стоимость: ' + priceFormat(Total) + ' \n'
            }
            orderparams += '-----\n';
